...
suspend fun addPost(context: ApiContext) {
    ...
    try {
        ...
        logger.logInfo("Add post request processed.")
    } catch (e: Exception) {
        logger.logError("Add post error: ${e.message}")
...
suspend fun updatePost(context: ApiContext) {
    ...
    try {
        ...
        logger.logInfo("Update post request processed.")
    } catch (e: Exception) {
        logger.logError("Update post error: ${e.message}")
        context.res.setBody(e.message)
    }
}
